...
export class hostelService {
    ...
    updateresident(rid, updatedData) {
        ...
        if (updatedData.name !== undefined)
            resident.name = updatedData.name;
        if (updatedData.age !== undefined)
            resident.age = updatedData.age;
        if (updatedData.phone !== undefined)
            resident.phone = updatedData.phone;
        if (updatedData.checkInDate !== undefined)
            resident.checkInDate = updatedData.checkInDate;
        // Save updated data
        this.saveData();
